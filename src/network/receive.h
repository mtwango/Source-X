...
protected:
	...
	bool doCreate(const CNetState * net, lpctstr charname, bool fFemale, RACE_TYPE rtRace, ushort wStr, ushort wDex, ushort wInt, PROFESSION_TYPE prProf,
...
public:
	PacketItemDropReq();
    uint getExpectedLength(CNetState* net, Packet* packet) override;
    bool onReceive(CNetState* net) override;
};
